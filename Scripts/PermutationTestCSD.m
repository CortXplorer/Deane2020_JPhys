...
which = 2;                  % 1 = Anesthetized vs Muscimol
                            % 2 = Anesthetized vs Awake
...
if which == 1 % these are within group and we can find difference between each animal
    obs_difmat = {};
...
elseif which == 2 % between group comparison
    obs1_means = {};
    obs1_std = {};
    obs2_means = {};
    obs2_std = {};
...
for itick = 1:ticklen
    ...
    elseif which == 2 % between group ttest2
...
cd(homedir); cd Data; mkdir('PermCSD'); cd('PermCSD');

if which == 1
    save Acute_permstats.mat sig_mass IIE_sig_mass IVE_sig_mass ...
