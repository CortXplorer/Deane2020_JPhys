            ...
            for i4 = 1:length(Cond.(Condition{iC}){iA})
                ...
                if ~isempty(measurement)
                    ...
                    if exist('SWEEP','var') %Acute recordings
                        ...
                        cd (homedir); cd Scripts; cd subfunc;
                        ...
                        %To create SWEEP
                        [BL, tone, Fs, SWEEP, frqz]=reformat(DATA); %Fs corrected to 1000 here (downsampling)
                    end
                    ...
                    % Sink durations
                    L.I_IIE = str2num(Layer.I_IIE{iA}); L.I_IIL = str2num(Layer.I_IIL{iA});  %#ok<*ST2NM>
